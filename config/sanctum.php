...
return [
    ...
    */
    ...
    | "expires_at" attribute. If null, tokens will never expire.
    |
    */
    ...
    | security scanning services which can identify tokens if they are
    | unintentionally committed to GitHub or other source control.
    |
    */
    ...
    | will need to serialize your user model and perform some other tasks
    | during the process. These middleware will be executed during the

...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('group_songs', function (Blueprint $table) {
            ...
            $table->foreignId('global_song_id')->constrained('global_songs')->onDelete('cascade');
            ...
            $table->unsignedSmallInteger('custom_tempo')->nullable()->comment('Custom tempo in BPM used by the group');
            $table->string('custom_time_signature', 10)->nullable()->comment('Custom time signature used by the group (e.g. 4/4, 3/4, 6/8)');
            $table->string('genre')->nullable()->comment('Musical genre of the song (e.g. worship, gospel, contemporary)');
        ...
        Schema::create('group_song_sections', function (Blueprint $table) {
            ...
            $table->string('label')->nullable()->comment('Human-readable label for the section (e.g. Verse 1, Chorus, Bridge)');
            ...
            $table->unsignedSmallInteger('order')->default(0)->comment('Display order of this section within the song');
            $table->timestamps();
        });
    }

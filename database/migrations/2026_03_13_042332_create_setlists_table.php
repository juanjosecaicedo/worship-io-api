...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('setlist_songs', function (Blueprint $table) {
            ...
            $table->unsignedInteger('order')->default(0)->comment('Position in the setlist');
            $table->string('key_override')->nullable()->comment('Key override for this song in this setlist');
        ...
        Schema::create('setlist_song_vocalists', function (Blueprint $table) {
            ...
            $table->string('key_override')->nullable()->comment('Key override for this song in this setlist');
            $table->string('notes')->nullable()->comment('For example: Only on the bridge, sing in falsetto');
            $table->timestamps();
        });
    }
